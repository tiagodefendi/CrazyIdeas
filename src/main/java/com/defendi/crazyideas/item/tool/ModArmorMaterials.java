...
public class ModArmorMaterials {
    ...
    public static final Holder<ArmorMaterial> EMERALD_ARMOR_MATERIAL = register(
            "emerald",
            Util.make(
    ...
    private static Holder<ArmorMaterial> register(
            String name, EnumMap<ArmorItem.Type, Integer> typeProtection,
            int enchantability, float toughness, float knockbackResistance,
            Supplier<Item> ingredientItem
    ) {
        ResourceLocation location = ResourceLocation.fromNamespaceAndPath(CrazyIdeas.MOD_ID, name);
        ...
        return Registry.registerForHolder(
                ...
                new ArmorMaterial(
                        typeProtection, enchantability, equipSound, ingredient,
